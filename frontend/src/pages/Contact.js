    ...
    <div style={styles.container}>
        ...
        {!isMobile && (
          <>
            <div style={styles.navLinks}>
              ...
              <a href="#" onClick={(e) => { e.preventDefault(); }} style={{ ...styles.navLink, color: '#00d1ff' }}>{lang.nav.contact}</a>
            </div>
      ...
      {isMobile && mobileMenuOpen && (
        <div style={styles.mobileMenu}>
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); setMobileMenuOpen(false); }} style={{ ...styles.mobileNavLink, color: '#00d1ff' }}>{lang.nav.contact}</a>
